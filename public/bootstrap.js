...
otstrap v3.3.5 (http://getbootstrap.com)
...
()
{
	var
		bodyPad
		=
		parseInt((this.$body.css('padding-right')
					||
					0),
				10)
		this.originalBodyPad
...
Modal.prototype.measureScrollbar
=
	function
()
{
		 ...
		 options)
		{
			this.enabled
				...
				$($.isFunction(this.options.viewport)
						?
						this.options.viewport.call(this,
							this.$element)
						:
		...
		if
			(!self)
			{
				self
					=
					new
					this.constructor(obj.currentTarget,
...
$tip.insertAfter(this.$element)
	this.$element.trigger('inserted.bs.'
			+
			this.type)
 ...
 placement)
{
	var
		...
		marginTop
		=
		parseInt($tip.css('margin-top'),
				10)
		var
		marginLeft
		=
		parseInt($tip.css('margin-left'),
				10)
					...
					if
						(!self)
						{
							self
								=
								new
								this.constructor(e.currentTarget,
										this.getDelegateOptions())
								$(e.currentTarget).data('bs.'
										+
										this.type,
														 ...
														 null)
															...
															if
																(e.isDefaultPrevented())
																	...
																	.addClass(affixType)
																	.trigger(affixType.replace('affix',
																				'affixed')
																			+
																			'.bs.affix')
												}
